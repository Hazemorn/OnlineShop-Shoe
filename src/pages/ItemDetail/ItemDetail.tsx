...
const ItemDetail = () => {
  ...
  const sexLabel = SEXES.find((item) => item.id === Number(sex))?.name || sex;
  ...
  return (
    <section className={s.detail}>
      ...
      <div className={s.detail__content}>
        ...
        <div className={s.detail__sex}>{sexLabel}</div>
        <div className={s.detail__count}>
          <div className={s.detail__count_wrapper}>
            <button onClick={() => decrease()} className={s.counter__decrease}>
              -
            </button>
            <h4>{count}</h4>
            <button onClick={() => increase()} className={s.counter__increase}>
              +
            </button>
          </div>
        </div>
        <div className={s.detail__add}>
          <p>
            <Tooltip
              ...
              children="!"
              placement="right"
              content="Please select a size before adding shoes"
            />
          </p>
          <Button
